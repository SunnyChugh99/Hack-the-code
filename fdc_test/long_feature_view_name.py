...
olist_customers_fvolist_customers_fvolist_customers_fvolist_customers_fvolist_customers_fvolist_customers_fv = FeatureView(
    name="olist_customers_fvolist_customers_fvolist_customers_fvolist_customers_fvolist_customers_fvolist_customers_fv",
...
customer_orders_fs = FeatureService(
    ...
    features=[order_items_fv, order_payments_fv, orders_fv, transformed_dollar_to_inr,
